    ...
    <div className="min-h-screen flex flex-col safe-top safe-bottom">
      <header className="sticky top-0 z-30 bg-graphite-900/95 backdrop-blur border-b border-graphite-700 px-4 py-3 safe-top">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={handleReset}
            className="min-h-touch min-w-[44px] flex items-center justify-center rounded-lg bg-graphite-800 active:bg-graphite-700"
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-30 px-4 pb-5 pt-3 bg-gradient-to-t from-graphite-950 via-graphite-950/95 to-transparent safe-bottom">
        <button
          ...
          className="w-full min-h-[64px] flex items-center justify-center gap-3 rounded-2xl bg-signal-green text-graphite-950 font-extrabold text-lg shadow-lg shadow-signal-green/20 active:opacity-85"
        >
          <Download size={26} />
